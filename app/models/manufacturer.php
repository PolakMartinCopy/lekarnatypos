...
class Manufacturer extends AppModel {
	...
	*/
	...
	function findBySnId($snId) {
		$manufacturer = $this->find('first', array(
			'conditions' => array('Manufacturer.id' => $snId),
			'contain' => array()
		));
	...
	function transformSn($snManufacturer) {
		$manufacturer = array(
			'Manufacturer' => array(
				...
				'name' => $snManufacturer['SnManufacturer']['name'],
				'logo_url' => $snManufacturer['SnManufacturer']['logo_url'],
				'www_address' => $snManufacturer['SnManufacturer']['www_address'],
				'supplier_alias' => $snManufacturer['SnManufacturer']['supplier_alias'],
				'active' => 1,
			)
		);
		return $manufacturer;
