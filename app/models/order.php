	...
	function build($customer, $cookie = null) {
		...
		foreach ($cart_products as $cart_product) {
			...
			$product = $this->OrderedProduct->Product->find('first', array(
				...
				'fields' => array('Product.id', 'Product.name', 'Product.wholesale_price', 'Manufacturer.id', 'Manufacturer.name', 'TaxClass.id', 'TaxClass.value')	
			));
			// data pro produkt
			...
			$ordered_products[$cp_count]['OrderedProduct']['product_wholesale_price'] = $product['Product']['wholesale_price'];
