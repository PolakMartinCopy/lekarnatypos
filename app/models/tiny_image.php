<?php  
class TinyImage extends AppModel { 
    ...
    function upload($data = null) { 
        ...
        if(!move_uploaded_file($this->data['TinyImage']['image']['tmp_name'], APP.WEBROOT_DIR.DS.'files/content-images'.DS.$this->data['TinyImage']['image']['name'])) { 
        	return false; 
        } 
