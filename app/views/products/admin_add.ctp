<h2>Vložit nový produkt</h2>
<div class="product">
<?php echo $form->create('Product', array('url' => '/admin/products/add/' . $category_id));?>
	<fieldset>
	...
	<?php
		echo $form->hidden('CategoriesProduct.category_id', array('value' => $category_id) );
	?>
	</fieldset>
...
<div class="actions">
	<ul>
		<li><?php echo $html->link(__('Zpět na seznam produktů', true), array('controller'=> 'categories', 'action'=>'list_products', $category_id)); ?> </li>
	</ul>
</div>