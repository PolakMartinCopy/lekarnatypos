...
<div class="ui-widget">
	<?php echo $form->create('Product', array('url' => array('controller' => 'products', 'action' => 'newest_add')))?>
...
<?php if (empty($newest)) { ?>
<p>Nejsou vybrány žádné produkty jako nejnovější.</p>
<?php } else { ?>
...
?>
	<tr <?php echo  $style?>>
		...
		<td style="font-size:12px;">
			<?php echo $html->link('Odstranit ze seznamu', array('controller' => 'products', 'action' => 'newest_delete', $product['Product']['id']))?>
		</td>
	</tr>
<?
	}
