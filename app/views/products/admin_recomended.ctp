...
<div class="ui-widget">
	<?php echo $form->create('Product', array('url' => array('controller' => 'products', 'action' => 'recomended_add')))?>
...
<p>Nejsou vybrány žádné produkty jako doporučené.</p>
<?php } else { ?>
...
?>
	<tr <?php echo  $style?>>
		...
		<td style="font-size:12px;">
			<?php echo $html->link('Odstranit ze seznamu', array('controller' => 'products', 'action' => 'recomended_delete', $product['Product']['id']))?>
		</td>
	</tr>
<?
	}
