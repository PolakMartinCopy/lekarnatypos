    ...
    $.widget( "custom.combobox", {
      ...
      _createAutocomplete: function() {
        ...
        this.input = $( "<input>" )
          ...
          .attr( "title", "" )
          .attr('size', 100)
          .attr('style', 'font-family: Arial, Tahoma, Verdana, Arial; font-size: 9pt;')
          .autocomplete({
          	delay: 0,
            minLength: 0,
...
<table class="tabulka">
	<tr>
		...
		<td>
			<div class="ui-widget">
			<?php
				echo $this->Form->input('AdminProductForm.Category.id', array('label' => false, 'type' => 'select', 'options' => $categories, 'empty' => false, 'div' => false))
			?>
			</div>
		</td>
	</tr>
