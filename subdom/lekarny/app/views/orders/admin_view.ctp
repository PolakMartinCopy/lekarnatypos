...
<span class="smallText"><?=$html->link('editovat objednávku', array('controller' => 'ordered_products', 'action' => 'edit', 'id' => $order['Order']['id'])) ?></span>
...
<table>
	<tr>
		<td colspan="3">
			<span class="smallText"><?=$html->link('editovat kontakty', array('controller' => 'orders', 'action' => 'edit_customer_info', 'id' => $order['Order']['id'])) ?></span>
		</td>
	</tr>
	<tr>
...
<table class="left_headed">
	<tr>
		<th>status:</th>
		<td>
			<?=$form->select('Order.status_id', $statuses, $order['Order']['status_id'], array(), false)?>
		</td>
	</tr>
	<tr>
		<th>poznámka:</th>
