...
<?php /* TAB 14 CS Faktury ****************************************************************************************************************/ ?>
	<div id="tabs-14">
		...
		<?php
			$hide = ' style="display:none"';
			if ( isset($this->data['CSInvoiceForm2']) ){
				$hide = '';
			}
		?>
		<div id="search_form"<?php echo $hide?>>
		
			<?php echo $form->create('CSInvoice', array('url' => array('controller' => 'business_partners', 'action' => 'view', $business_partner['BusinessPartner']['id'], 'tab' => 14)))?>
			<table class="left_heading">
				<tr>
					<td colspan="6">Odběratel</td>
				</tr>
				<tr>
					<th>Jméno</th>
					<td><?php echo $form->input('CSInvoiceForm2.BusinessPartner.name', array('label' => false))?></td>
					<th>IČO</th>
					<td><?php echo $form->input('CSInvoiceForm2.BusinessPartner.ico', array('label' => false))?></td>
					<th>DIČ</th>
					<td><?php echo $form->input('CSInvoiceForm2.BusinessPartner.dic', array('label' => false))?></td>
				</tr>
				<tr>
					<th>Ulice</th>
					<td><?php echo $this->Form->input('CSInvoiceForm2.Address.street', array('label' => false))?></td>
					<th>Město</th>
					<td><?php echo $this->Form->input('CSInvoiceForm2.Address.city', array('label' => false))?></td>
					<th>Okres</th>
					<td><?php echo $this->Form->input('CSInvoiceForm2.Address.region', array('label' => false))?></td>
				</tr>
				<tr>
				...
				<tr>
					<th>Číslo dokladu</th>
					<td><?php echo $this->Form->input('CSInvoiceForm2.CSInvoice.code', array('label' => false))?></td>
					<th>Datum vystavení od</th>
					<td><?php echo $this->Form->input('CSInvoiceForm2.CSInvoice.date_of_issue_from', array('label' => false))?></td>
					<th>Datum vystavení do</th>
					<td><?php echo $this->Form->input('CSInvoiceForm2.CSInvoice.date_of_issue_to', array('label' => false))?></td>
				</tr>
					<th>Obchodník</th>
					<td><?php echo $this->Form->input('CSInvoiceForm2.CSInvoice.user_id', array('label' => false, 'empty' => true))?></td>
					<th>Datum splatnosti od</th>
					<td><?php echo $this->Form->input('CSInvoiceForm2.CSInvoice.due_date_from', array('label' => false))?></td>
					<th>Datum splatnosti do</th>
					<td><?php echo $this->Form->input('CSInvoiceForm2.CSInvoice.due_date_to', array('label' => false))?></td>
				<tr>
					<th>Kód skupiny</th>
					<td><?php echo $this->Form->input('CSInvoiceForm2.Product.group_code', array('label' => false))?></td>
					<th>Kód VZP</th>
					<td><?php echo $this->Form->input('CSInvoiceForm2.Product.vzp_code', array('label' => false))?></td>
				</tr>
				<tr>
					<td colspan="6">
						<?php echo $html->link('reset filtru', $_SERVER['REQUEST_URI'] . '/reset:c_s_invoices') ?>
					</td>
				</tr>
			</table>
			
			<?php
				echo $form->hidden('CSInvoiceForm2.CSInvoice.search_form', array('value' => 1));
				echo $form->submit('Vyhledávat');
				echo $form->end();
			?>
		...
		<script>
			...
			$(function() {
				var model = 'CSInvoice';
				var dateOfIssueFromId = model + 'Form2' + model + 'DateOfIssueFrom';
				var dateOfIssueToId = model + 'Form2' + model + 'DateOfIssueTo';
				...
				var dueDateFromId = model + 'Form2' + model + 'DueDateFrom';
				var dueDateToId = model + 'Form2' + model + 'DueDateTo';
		...
		<table class="top_heading">
			<tr>
				...
				<th><?php echo $this->Paginator->sort('Název zboží', 'CSProduct.name')?></th>
			...
			?>
			<tr<?php echo $odd?>>
				<td><?php echo $this->Html->link($invoice['CSInvoice']['code'], '/' . CSI_FOLDER . $invoice['CSInvoice']['code'] . '.pdf')?></td>
				<td><?php echo $invoice['BusinessPartner']['name']?></td>
				...
				<td><?php echo $invoice['CSProduct']['name']?></td>
				...
				<td><?php 
					echo $this->Html->link('Upravit', array('controller' => 'c_s_invoices', 'action' => 'edit', $invoice['CSInvoice']['id'], 'business_partner_id' => $business_partner['BusinessPartner']['id'])) . ' | ';
					echo $this->Html->link('Smazat', array('controller' => 'c_s_invoices', 'action' => 'delete', $invoice['CSInvoice']['id'], 'business_partner_id' => $business_partner['BusinessPartner']['id']), array(), 'Opravdu chcete fakturu smazat?') . ' | ';
					echo $this->Html->link('Smazat položku', array('controller' => 'c_s_transaction_items', 'action' => 'delete', $invoice['CSTransactionItem']['id'], 'business_partner_id' => $business_partner['BusinessPartner']['id']), array(), 'Opravdy chcete položku vymazat?') . ' | ';
				?></td>
			</tr>
			<?php } ?>
		</table>
...
?>
		<div id="search_form"<?php echo $hide?>>
			...
			<?php echo $form->create('CSCreditNote', array('url' => array('controller' => 'business_partners', 'action' => 'view', $business_partner['BusinessPartner']['id'], 'tab' => 15)))?>
			<table class="left_heading">
				<tr>
					<td colspan="6">Odběratel</td>
				</tr>
				<tr>
					<th>Jméno</th>
					<td><?php echo $form->input('CreditNoteForm2.BusinessPartner.name', array('label' => false))?></td>
					<th>IČO</th>
					<td><?php echo $form->input('CreditNoteForm2.BusinessPartner.ico', array('label' => false))?></td>
					<th>DIČ</th>
					<td><?php echo $form->input('CreditNoteForm2.BusinessPartner.dic', array('label' => false))?></td>
				</tr>
				<tr>
					<th>Ulice</th>
					<td><?php echo $this->Form->input('CreditNoteForm2.Address.street', array('label' => false))?></td>
					<th>Město</th>
					<td><?php echo $this->Form->input('CreditNoteForm2.Address.city', array('label' => false))?></td>
					<th>Okres</th>
					<td><?php echo $this->Form->input('CreditNoteForm2.Address.region', array('label' => false))?></td>
				</tr>
				<tr>
					<td colspan="4">Faktura</td>
					<td colspan="2">Zboží</td>
				...
				<tr>
					<th>Číslo dokladu</th>
					<td><?php echo $this->Form->input('CreditNoteForm2.CSCreditNote.code', array('label' => false))?></td>
					<th>Datum vystavení od</th>
					<td><?php echo $this->Form->input('CreditNoteForm2.CSCreditNote.date_of_issue_from', array('label' => false))?></td>
					<th>Datum vystavení do</th>
					<td><?php echo $this->Form->input('CreditNoteForm2.CSCreditNote.date_of_issue_to', array('label' => false))?></td>
				</tr>
					<th>Obchodník</th>
					<td><?php echo $this->Form->input('CreditNoteForm2.CSCreditNote.user_id', array('label' => false, 'empty' => true))?></td>
					<th>Datum splatnosti od</th>
					<td><?php echo $this->Form->input('CreditNoteForm2.CSCreditNote.due_date_from', array('label' => false))?></td>
					<th>Datum splatnosti do</th>
					<td><?php echo $this->Form->input('CreditNoteForm2.CSCreditNote.due_date_to', array('label' => false))?></td>
				<tr>
					<th>Kód skupiny</th>
					<td><?php echo $this->Form->input('CreditNoteForm2.Product.group_code', array('label' => false))?></td>
					<th>Kód VZP</th>
					<td><?php echo $this->Form->input('CreditNoteForm2.Product.vzp_code', array('label' => false))?></td>
				</tr>
				<tr>
					<td colspan="6">
						<?php echo $html->link('reset filtru', $_SERVER['REQUEST_URI'] . '/reset:c_s_credit_notes') ?>
					</td>
				</tr>
			</table>
			
			<?php
				echo $form->hidden('CSCreditNoteForm2.CSCreditNote.search_form', array('value' => 1));
				echo $form->submit('Vyhledávat');
				echo $form->end();
			?>
	...
	<table class="top_heading">
		...
		?>
		<tr<?php echo $odd?>>
			<td><?php echo $this->Html->link($credit_note['CSCreditNote']['code'], '/' . CSI_FOLDER . $credit_note['CSCreditNote']['code'] . '.pdf')?></td>
			<td><?php echo $credit_note['BusinessPartner']['name']?></td>
			...
			<td><?php echo $credit_note['CSProduct']['name']?></td>
			...
			<td><?php 
				echo $this->Html->link('Upravit', array('controller' => 'c_s_credit_notes', 'action' => 'edit', $credit_note['CSCreditNote']['id'], 'business_partner_id' => $business_partner['BusinessPartner']['id'])) . ' | ';
				echo $this->Html->link('Smazat', array('controller' => 'c_s_credit_notes', 'action' => 'delete', $credit_note['CSCreditNote']['id'], 'business_partner_id' => $business_partner['BusinessPartner']['id']), array(), 'Opravdu chcete dobropis smazat?') . ' | ';
				echo $this->Html->link('Smazat položku', array('controller' => 'c_s_transaction_items', 'action' => 'delete', $credit_note['CSTransactionItem']['id'], 'business_partner_id' => $business_partner['BusinessPartner']['id']), array(), 'Opravdy chcete položku vymazat?') . ' | ';
			?></td>
		</tr>
		<?php } ?>
	</table>
...
<?php /* TAB 16 CS Pohyby ****************************************************************************************************************/ ?>
	<div id="tabs-16">
		...
		<div id="search_form"<?php echo $hide?>>
			...
			<?php echo $form->create('CSTransaction', array('url' => array('controller' => 'business_partners', 'action' => 'view', $business_partner['BusinessPartner']['id'], 'action' => 'index')))?>
			<table class="left_heading">
				<tr>
					<td colspan="6">Odběratel</td>
				</tr>
...
?>
	...
	<table class="top_heading">
		...
		<tr<?php echo $odd?>>
			...
			<td><?php 
				echo $this->Html->link('Upravit', array('controller' => $controller, 'action' => 'edit', $transaction['CSTransaction']['id'], 'business_partner_id' => $business_partner['BusinessPartner']['id'])) . ' | ';
				echo $this->Html->link('Smazat', array('controller' => $controller, 'action' => 'delete', $transaction['CSTransaction']['id'], 'business_partner_id' => $business_partner['BusinessPartner']['id']), array(), 'Opravdu chcete transakci smazat?') . ' | ';
				echo $this->Html->link('Smazat položku', array('controller' => 'c_s_transaction_items', 'action' => 'delete', $transaction['CSTransaction']['item_id'], 'business_partner_id' => $business_partner['BusinessPartner']['id']), array(), 'Opravdu chcete položku vymazat?');
			?></td>
		</tr>
		<?php } ?>
	</table>
